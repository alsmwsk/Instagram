...
public class GridImageAdapter extends ArrayAdapter<String> {
    ...
    public GridImageAdapter(@NonNull Context context, int layoutResource, String append, ArrayList<String> imgURLs) {
    ...
    //위젯을 한번에 전부 로드하는게 아니라 여러번에 걸쳐서 리사이클링을 해서 로드..
    //ViewHolder pattern
    @NonNull
    @Override
